...
我尝试简单解读下上述的表格，偏主观，仅供参考：

IDC/Snowflake 多为用例/部门的自报 ROI，且样本偏已采用者/早期采用者，结论偏乐观；McKinsey 强调企业级 EBIT 归因，结论更保守；MIT NANDA 用短窗（6 个月）+“GenAI 工具部署成功且带来可衡量的收益”的严格成功定义，样本量虽小，而且更关注于实际的 P&L 收益，标准高，同时 AI 的 J 型收益曲线，收益还未显现，导致结论偏悲观。

口径差异——“乐观 vs. 审慎”——是主因，同样地，样本差异——“已用 vs. 全企”的差异——也导致些许差异。

这样理解下来，我认为，可能本报告 5%的成功率可能过于悲观。但是，GenAI 工具对于企业的收益提升不明显，而且落地困难这个事情是确实普遍存在的。
