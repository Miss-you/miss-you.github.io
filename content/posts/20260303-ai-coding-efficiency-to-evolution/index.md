...
![SDLC 瓶颈：编码加速但 Code Review 堆积](img/fa9fd9590e20689cc7d8c4272ee342e1.png)
...
![Spec/Rule/Skill 三者关系](img/7d5a8fc3f7f549288ab331e369483ecb.png)

**关键洞察：区别不在语义标签，在加载机制。**

三者在大模型上下文中的物理位置和生命周期完全不同。Rule 始终驻留在上下文头部。Skill 按需加载到上下文尾部，靠近模型即将生成内容的位置。Spec 作为 Skill 的输入数据被注入。

![LLM 上下文窗口：Rule 头部常驻 vs Skill 尾部按需加载](img/6cf73db906e6066b77e9d5bd35f2461d.png)
...
![验证闭环：generate → verify → fix/log](img/ce3e9ab57bf4fbed187b27964c2404c2.png)
...
![四层拦截的瑞士奶酪模型](img/34af4ee8250421316a11e6714ae01311.png)
...
![并行运行多个 AI 会话](img/577801e03a43a428ff0453cd62bb46f2.png)
...
![10 个 Agent 并行拆解报告，主 Agent 聚合交叉验证](img/8b0451536f7ede674efbbf1a063ce3f9.png)
...
![ROI 甜点区](img/6abb329bb46bc5035444bf12a6fe992c.png)
