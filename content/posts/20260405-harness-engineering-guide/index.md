...
draft: false
lang: zh
tags: ["AI Agent", "Harness Engineering", "Claude Code", "LLM"]
categories: ["AI"]
description: "从 Anthropic、OpenAI、Cursor 三家头部公司的 14 篇工程文章出发，拆解 Harness Engineering 的三层架构：流程管控、并发调度、验证对抗，以及模型进步后的减法逻辑。"
cover:
    image: "https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/01-goldfish-cognitive-overload.jpg"
    alt: "金鱼在桌前焦虑地翻书，纸团满地——大模型认知过载的隐喻"
    relative: false
---

> 作者：Yousa 博阳 | 编辑：徐青阳 | 游戏学习笔记 | 2026 年 4 月 5 日
...
为了解决过去有效上下文实在少得可怜，完成不了任务的问题，最早的路径之一就是记忆外化。AutoGPT 在 2023 年 3 月就给模型发了空白本子—— 一个 write_to_file 和 read_file 的工具调用权限，然后让它自己管理记忆。载体是纯 .txt 文件，没有任何结构约束。模型爱写什么写什么，爱删什么删什么。
...
![Anthropic 工程博客：Effective harnesses for long-running agents](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/02-anthropic-effective-harnesses.jpg)
...
![上下文重置：旧金鱼的混乱记忆通过一份交接单传给全新的金鱼](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/05-context-reset-handoff.jpg)
...
![金鱼工人打卡上班，流水线上是 JSON 数据箱——Harness 就是这套工业管理制度](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/04-factory-assembly-line.jpg)
...
![交通十字路口完全堵死——多 Agent 并发失控的隐喻](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/06-traffic-chaos-gridlock.jpg)
...
![Cursor 博客：Scaling long-running autonomous coding](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/07-cursor-scaling-autonomous-coding.jpg)
...
![规划器居中调度，六个执行器各司其职——未经批准，不准动手](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/08-planner-worker-architecture.jpg)
...
![Anthropic 博客：Building a C compiler with a team of parallel Claudes](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/09-anthropic-parallel-claudes.jpg)
...
![教室里只有一只金鱼认真考试，其他都戴着墨镜摸鱼——验证缺失的现状](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/10-evaluation-problem-classroom.jpg)
...
![Anthropic 博客：Harness design for long-running application development](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/03-anthropic-harness-design.jpg)
...
![Cursor 博客：Building a better Bugbot](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/11-cursor-better-bugbot.jpg)
...
![沙盒中的金鱼只有隔离输出，外部评估员独立验证——测试结果：失败](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/12-sandbox-evaluator.jpg)
...
![金鱼挥锤拆砖墙——墙上写着 Context Reset、Sprint Contract、Evaluator](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/13-demolishing-harness-components.jpg)
...
![补偿面迁移：金鱼骑在补丁毯上前行，旧补丁飞离，新补丁铺展](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/14-compensatory-surface-migration.jpg)
...
![金鱼侦探用放大镜审视 51.2 万行源码的架构图——记忆、协调器、梦系统、钩子、团队模式](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/15-source-code-investigation.jpg)
...
![六层记忆体系书架：从组织策略到当前对话，上层覆盖下层，底部梦系统自动整理](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/16-six-layer-memory-system.jpg)
...
![团队模式对比：左侧单鱼水位 90% 不堪重负，右侧多鱼各 40% 分工协作](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/17-team-mode-comparison.jpg)
...
![窗台三件套：凯洛斯（主动时机判断）、风险分级、钩子插件接口——不是怎么干活，而是怎么好用](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/18-beyond-harness-infrastructure.jpg)
...
![补偿面不只是在迁移，而是在膨胀：旧拼图脱落，新拼图向更高维度延伸](https://raw.githubusercontent.com/Miss-you/img/master/blog/harness-engineering-guide/19-compensatory-surface-expansion.jpg)
